...
#ifndef PSLP_BP_PRICER_CPLEX_PA_HPP
#define PSLP_BP_PRICER_CPLEX_PA_HPP
...
/**
 * CPLEX-based variable pricer with position assignment formulation for the PSLP.
 */
class PricerCplexPa : public PricerCplex
{
public:
    /**
