...
#ifndef PSLP_BP_PRICER_CPLEX_LO_HPP
#define PSLP_BP_PRICER_CPLEX_LO_HPP
...
/**
 * CPLEX-based variable pricer with linear ordering formulation for the PSLP.
 */
class PricerCplexLo : public PricerCplex
{
public:
    /**
