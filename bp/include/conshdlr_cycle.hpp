...
#ifndef PSLP_BP_CONSHDLR_CYCLE_HPP
#define PSLP_BP_CONSHDLR_CYCLE_HPP
...
/**
 * Constraint handler for cycle elimination constraints.
 */
class ConshdlrCycle : public scip::ObjConshdlr
{
public:
    /**
