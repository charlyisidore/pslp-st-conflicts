...
#ifndef PSLP_BP_PRICER_CPLEX_LAZY_HPP
#define PSLP_BP_PRICER_CPLEX_LAZY_HPP
...
/**
 * CPLEX-based variable pricer with lazy constraints formulation for the PSLP.
 */
class PricerCplexLazy : public PricerCplex
{
public:
    /**
